...
export const processHighlights = [
  ...
  },
  {
    ...
    text: "Las fases, entregables y ventanas de validación están claras desde el inicio para que cada organización pueda planificar su tiempo sin improvisación.",
  },
  {
    title: "Herramientas que quedan en tu organización",
    text: "El proceso deja plantillas, criterios y material de trabajo que siguen siendo útiles después del cierre del acompañamiento.",
  },
];
...
export const preparationChecklist = [
  "Misión y visión vigentes, si ya existen.",
  "Plan estratégico anterior, si lo tienen.",
...
export const workRules = [
  {
    title: "Puntualidad y aviso previo",
    detail: "Conectarse a tiempo y notificar ausencias con antelación ayuda a sostener el ritmo de avance.",
  },
  {
    title: "Confidencialidad",
    detail: "La información de cada organización se utiliza exclusivamente para este proceso de acompañamiento.",
  },
  {
    title: "Decisiones claras",
    detail: "El punto focal coordina, pero el liderazgo debe validar hitos y entregables clave.",
  },
  {
    title: "Primero avanzar, luego pulir",
    detail: "La prioridad es llegar a un borrador robusto y utilizable; el refinamiento viene después.",
  },
];
...
export const outcomes = [
  {
    ...
    detail: "Un punto de partida claro para entender la situación actual de la organización.",
  },
  {
    title: "Plantilla editable",
    detail: "Una base profesional para seguir ajustando el plan sin depender de formatos complejos.",
  },
  {
    title: "Borrador avanzado",
    detail: "Una versión estructurada del plan estratégico construida durante el proceso.",
  },
  {
